...
public class Area {
  ...
  /**
   * Define an area to make checking for certain events easier. You can also define areas to have their own settings
   * (Area.getSettings()). Area settings will not take effect unless useSettings() is set to true. Loc1 and loc2 will be
   * re-written so that loc1 is always the "lowest" position, and loc2 to be the "highest"
   *
