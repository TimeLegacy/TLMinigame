...
public class ArenaSettings {
  ...
  /**
   * ArenaSettings can be used for blocking certain events easier, without having to listen for each one. For example,
   * most minigames don't allow block breaking. Instead of cancelling an event, you can use:
   * ArenaSettings.setCanBuild(false). Also sets a default priority of 0 for Areas or -1 for Arenas (see
   * ArenaSettings.getPriority() for more on how this works).
   */
  ...
  /**
   * Get the priority these settings take. Higher number = higher priority. Default: 0 for Areas, -1 for Arenas.
   *
  ...
  /**
   * Set the priority these settings take. Higher number = higher priority Default: 0 for Areas, -1 for Arenas.
   *
