...
public class GamePlayer {
  ...
  /**
   * Get the Bukkit (offline) player. For the online player, use getOnlinePlayer(). Make sure you check if the player is
   * online with isOnline()!
   *
  ...
  /**
   * Set the game this player is in. Used by the internal API, bad things might happen if you set this yourself!
   *
